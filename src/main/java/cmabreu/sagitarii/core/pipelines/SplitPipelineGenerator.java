...
public class SplitPipelineGenerator implements IPipelineGenerator {
	...
	public List<Pipeline> generatePipelines(Activity activity, Fragment frag) throws Exception {
		...
		logger.debug("'SPLIT' type detected: " + utes.size() + " pipelines will be created for activity " + activity.getTag());
