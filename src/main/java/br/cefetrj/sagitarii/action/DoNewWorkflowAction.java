...
@Action (value = "doNewWf", results = { @Result (type="redirect", location = "indexRedir", name = "ok") 
}, interceptorRefs= { @InterceptorRef("seguranca")	 } ) 

@ParentPackage("default")
public class DoNewWorkflowAction extends BasicActionClass {
