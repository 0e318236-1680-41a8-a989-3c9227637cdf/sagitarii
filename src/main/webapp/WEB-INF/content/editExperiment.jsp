...
<%@ include file="../../header.jsp" %>
				...
				<div id="leftBox"> 
					...
					<div id="basicCentralPanel">
						...
						<div class="basicCentralPanelBar" style="height: 50px;">
							...
							<div class="basicCentralPanelBarText">Manage Activities for Experiment ${experiment.tagExec} <br>Workflow "${experiment.workflow.description}"</div>
						</div>
				...
				<div id="rightBox"> 
					...
					<div class="userBoard" id="actDetailBox" style="height: 230px; display:none">
