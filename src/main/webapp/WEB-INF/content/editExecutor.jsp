				...
				<div id="leftBox"> 
					...
					<div id="basicCentralPanel">
						...
						<div class="basicCentralPanelBar">
							...
							<div class="basicCentralPanelBarText">Edit Executor ${executor.type} ${executor.executorAlias}</div>
						</div>
						...
						<form method="post" action="updateExecutor" id="frmSave" enctype="multipart/form-data">
							<input type="hidden" id="stmtField" name="executor.selectStatement">
							<input type="hidden" name="executorTarget" value="${executor.type}">
							...
							<div id="typeMapPanel" class="menuBarMain" style="display:table;height:52px;margin-top:5px;">
								<table style="margin-top:10px;width:450px;margin-left:10px" >
									<tr>
										...
										<td><input value="${executor.executorAlias}" maxlength="20" size="22" id="executorAlias" name="executorAlias" style="width:98%" class="tableCellFormInput" type="text" ></td>
									</tr>	
									<tr>
