...
import br.cefetrj.parser.sagitarii.SagitariiLexer;
import br.cefetrj.parser.sagitarii.SagitariiParser;
import br.cefetrj.parser.sagitarii.SagitariiParser.ActivitySentenceContext;
import br.cefetrj.parser.sagitarii.SagitariiParserListener;
...
public class Main {
	...
	private static void parseExpression(String drinkSentence) {
	    ...
	    ParseTree tree = activitySentenceContext;
	    TreePrinterListener tpl = new TreePrinterListener(ruleNames);
	    ParseTreeWalker.DEFAULT.walk(tpl, tree);
	    String formatted = tpl.toString();	    
	...
	public static void main(String[] args) {
		String sentence1 = "map myExecutor1 ( inputtable, input2 ) to outputtable as activity";
