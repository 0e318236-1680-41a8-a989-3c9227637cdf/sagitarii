...
public interface SagitariiListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SagitariiParser#parallelActivitySentence}.
	 * @param ctx the parse tree
	 */
	void enterParallelActivitySentence(SagitariiParser.ParallelActivitySentenceContext ctx);
	/**
	 * Exit a parse tree produced by {@link SagitariiParser#parallelActivitySentence}.
	 * @param ctx the parse tree
	 */
	void exitParallelActivitySentence(SagitariiParser.ParallelActivitySentenceContext ctx);
	/**
